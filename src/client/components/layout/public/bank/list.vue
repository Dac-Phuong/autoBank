<template>
    <div>
        <UiFlex class="gap-2 mb-4">
            <UiText :text="title" weight="medium" color="secondary" size="lg" />
        </UiFlex>
        ...
        <div v-else>
            ...
            <div class="grid grid-cols-12 lg:gap-6 md:gap-4 gap-2 md:mb-6 mb-4" v-else>
                <LayoutPublicBankItem v-for="item in list" :key="item._id" :item="item" class="xl:col-span-3 lg:col-span-4 md:col-span-6 col-span-12" />
            </div>
